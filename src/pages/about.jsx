        ...
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            <div className="max-w-[560px] relative pt-6">
              ...
              <p className="absolute top-0 left-0 text-[11px] tracking-[0.3em] text-[#9fb2bb]">
                経歴
              </p>
            ...
            <div className="flex flex-col items-center">
              ...
              <img
                ...
                className="w-full max-w-[320px] md:max-w-[420px] h-[320px] md:h-[420px] object-cover object-[center_35%]"
              />

              {/* SP CTA */}
              <div className="md:hidden w-full max-w-[320px] flex justify-end mt-2">
                <div className="flex items-center gap-3">
          ...
          <div className="max-w-[900px] mx-auto grid md:grid-cols-3 gap-12 md:gap-16 text-left mt-4 md:mt-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-[#6b7c85] text-[13px] leading-[1.7] font-light">
                ...
                <p className="whitespace-nowrap">
                  <span translate="no">AIDA フリーダイビングインストラクター</span>
                </p>

                <p>
                  <span translate="no">YOGA インストラクター RYT200</span>
                </p>
            ...
            <div>
              ...
              <div className="space-y-4 text-[#6b7c85] text-[13px] leading-[1.9] font-light">
                <p><span translate="no">AIDA Panglao Depth games TAIWAN CUP 2023</span></p>
                <p><span translate="no">15TH AIDA PANGLAO DEPTH GAMES 2023 FINAL</span></p>
                <p><span translate="no">AIDA Volcano Cup 2024</span></p>
                <p><span translate="no">21st AIDA Panglao Depth Games Final 2024</span></p>
                <p><span translate="no">AIDA Panglao Depth Championship 2024 -2</span></p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-[#6b7c85] text-[13px] leading-[1.9] font-light">
                <p><span translate="no">AIDA Yuinoshima Freediving Cup 2nd🥈</span></p>
                <p><span translate="no">AIDA Freediving Pool Games Japan Suzuka 1st🥇</span></p>
                <p><span translate="no">AIDA Freediving Pool Games Japan Kusatsu 2nd🥈</span></p>
                <p><span translate="no">AIDA Freediving Pool Games Japan Wakayama 3rd🥉</span></p>
                <p><span translate="no">AIDA JAPAN FREEDIVING POOL CHAMPIONSHIPS 2026 女子CWTB 1st🥇</span></p>
              </div>
            </div>
